...
// Created function to ask user to type 8-128 characters, to include uppercase, lowercase, numbers, and symbols.
function questions() {
  var isValid = false;
  do {
...
// This function joins all the user responses and then creates the result - a strong random password.
